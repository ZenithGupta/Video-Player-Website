    ...
    return (
        <div className={`social-sidebar-container ${isVisible ? 'visible' : 'hidden'}`}>
            ...
            <div className="social-sidebar">
                ...
                <a href="https://www.instagram.com/physiopridetamil?igsh=MWJmbWQ0bjYwZ29nNg==" className="social-link instagram" title="Instagram" target="_blank" rel="noopener noreferrer">
                    <InstagramIcon />
